...
// Ordered plan chosen.
assertUnhintedExplain( { cursor:'IndexCursor a_1_b_1', n:30, nscanned:30, nscannedObjects:30,
                         scanAndOrder:false },
                       t.find( { b:{ $gte:0 } } ).sort( { a:1 } ) );

// Ordered plan chosen with a covered index.
assertUnhintedExplain( { cursor:'IndexCursor a_1_b_1', n:30, nscanned:30, nscannedObjects:0,
                         scanAndOrder:false },
