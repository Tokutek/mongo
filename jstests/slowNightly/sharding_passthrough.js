...
files.forEach(
	...
	if (/[\/\\](6072_touch|dbadmin|error1|fsync|fsync2|geo.*|indexh|remove5|update4|loglong|logpath|notablescan|compact.*|check_shard_index|bench_test.*|mr_replaceIntoDB|mr_auth|queryoptimizera|txn_.*|query_write_lock|bug301|collection_exists_cmd|getNamespaces_after_close|ops_after_close|collections_exist_cmd)\.js$/.test(x.name)) {
