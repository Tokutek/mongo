...
assert.eq( "IndexCursor tags_1" , t.find( q1 ).explain().cursor , "e1" );
assert.eq( "IndexCursor tags_1" , t.find( q2 ).explain().cursor , "e2" );
assert.eq( "IndexCursor tags_1" , t.find( q3 ).explain().cursor , "e3" );
