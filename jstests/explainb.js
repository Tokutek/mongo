...
assert.eq( 4, explain.nscannedAllPlans );
...
assert.eq( 2, explain.nscannedAllPlans );
...
assert.eq( 1, explain.clauses[ 0 ].nscannedObjectsAllPlans );
assert.eq( 3, explain.clauses[ 0 ].nscannedAllPlans );
assert.eq( 1, explain.clauses[ 1 ].n );
assert.eq( 1, explain.clauses[ 1 ].nscannedObjects );
assert.eq( 1, explain.clauses[ 1 ].nscanned );
assert.eq( 1, explain.clauses[ 1 ].nscannedObjectsAllPlans );
assert.eq( 2, explain.clauses[ 1 ].nscannedAllPlans );
assert.eq( 2, explain.n );
...
assert.eq( 2, explain.nscannedObjectsAllPlans );
assert.eq( 5, explain.nscannedAllPlans );
...
// dup.
assert.eq( 1, explain.nscannedObjectsAllPlans );
