...
doIDPKTest = function (signal, txnLimit, startPort) {
    var num = 3;
...
doCustomPKTest = function (signal, txnLimit, startPort) {
    var num = 3;
    var host = getHostName();
    var name = "rollback_unit";
    var timeout = 60000;
...
doSecondaryKeyTest = function (signal, txnLimit, startPort) {
    var num = 3;
    var host = getHostName();
    var name = "rollback_unit";
    var timeout = 60000;
...
doSecondaryKeyTest(15, 1000000, 31000);
doCustomPKTest(15, 1000000, 31000);
doIDPKTest(15, 1000000, 31000);
