...
assert( db.factories.find( { metro: { city: "New York", state: "NY" } } ).explain().cursor == "IndexCursor metro_1" )

assert( db.factories.find( { metro: { $gte : { city: "New York" } } } ).explain().cursor == "IndexCursor metro_1" )
