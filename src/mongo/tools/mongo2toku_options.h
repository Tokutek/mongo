...
namespace mongo {
    ...
    struct Mongo2TokuGlobalParams {
        ...
        std::string ruser;
        std::string rpass;
        std::string rauthenticationDatabase;
        std::string rauthenticationMechanism;
    };

    extern Mongo2TokuGlobalParams mongo2TokuGlobalParams;
