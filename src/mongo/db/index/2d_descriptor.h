...
namespace mongo {
    ...
    class TwoDDescriptor : public Descriptor {
    public:
        // For creating a brand new descriptor.
        TwoDDescriptor(const BSONObj &keyPattern,
                       const string &geo,
        ...
        TwoDDescriptor(const char *data, const size_t size);
    ...
    private:
        ...
        GeoHashConverter::Parameters _params;
    };
