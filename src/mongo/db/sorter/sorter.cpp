...
namespace mongo {
    namespace sorter {
        ...
        public:
            ...
            {
                massert(17358, str::stream() << "error opening file \"" << _fileName << "\": "
                                             << errnoWithDescription(),
                        _file.good());

                massert(17359, str::stream() << "unexpected empty file: " << _fileName,
        ...
        private:
            ...
            void fill() {
                ...
                massert(17360, "file too short?", !_done);
            ...
            void read(void* out, size_t size) {
                ...
                if (!_file.good()) {
                    ...
                    msgasserted(17361, str::stream() << "error reading file \""
                                                     << _fileName << "\": "
                                                     << errnoWithDescription());
                }
