...
namespace mongo {
    ...
    namespace old_matcher {
        ...
        public:
            ...
            void init() {
                ...
                _scope = globalScriptEngine->getPooledScope(nsToDatabase(_ns).c_str(), "where" );
    ...
    using namespace mongo::old_matcher;

    void MatcherOld::addRegex(const char *fieldName, const char *regex, const char *flags, bool isNot) {
    ...
    bool MatcherOld::addOp( const BSONElement &e, const BSONElement &fe, bool isNot, const char *& regex, const char *&flags ) {
    ...
    bool MatcherOld::parseClause( const BSONElement &e ) {
    ...
    // $where: function()...
    NOINLINE_DECL void MatcherOld::parseWhere( const BSONElement &e ) { 
    ...
    void MatcherOld::parseMatchExpressionElement( const BSONElement &e, bool nested ) {
     ...
     */
    MatcherOld::MatcherOld(const BSONObj &jsobj, bool nested) :
    ...
    MatcherOld::MatcherOld( const MatcherOld &docMatcher, const BSONObj &key ) :
    ...
    inline int MatcherOld::valuesMatch(const BSONElement& l, const BSONElement& r, int op, const ElementMatcher& bm) const {
    ...
    int MatcherOld::inverseMatch(const char *fieldName, const BSONElement &toMatch, const BSONObj &obj, const ElementMatcher& bm , MatchDetails * details ) const {
    ...
    /* Check if a particular field matches.
       ...
       1 match
    */
    int MatcherOld::matchesDotted(const char *fieldName, const BSONElement& toMatch, const BSONObj& obj, int compareOp, const ElementMatcher& em , bool isArr, MatchDetails * details ) const {
     ...
     */
    bool MatcherOld::matches(const BSONObj& jsobj , MatchDetails * details ) const {
        /*
